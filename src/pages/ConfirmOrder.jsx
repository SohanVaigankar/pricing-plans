  ...
  return (
    <>
      ...
      <div className="p-5 w-[95%] md:w-[90%] lg:w-[80%] mx-auto flex justify-center  items-center py-10 mt-20  ">
        <div className="flex flex-col items-center  mx-auto w-[100%] sm:w-[75%] lg:w-[60%] 2xl:w-[40%]  rounded border-[1px]  border-[#4545c0ab]">
          <p className="w-full text-center px-2 py-2 text-[1.5rem] border-b-[1px] border-[#4545c0ab] text-[#4545c0]">
            Confirm Order?
          </p>
